<div class="page region-dashboard" id="region-dashboard-subregion">
    <div class="container header-container">
        <div class="row">
            <div class="col-md-12 header">
                <?php print _hbs_dashboard_messages('region_subregion_top'); ?>
            </div>
        </div>
    </div>
    ...
    <div class="container sub-regional-wages-container">
        <div class="row">
            <div class="col-md-12 header">
                ...
                <?php print _hbs_dashboard_messages('region_subregion_wages'); ?>
            </div>
    ...
    <div class="container scatterplot-container last">
        <div class="row">
            <div class="col-md-12 header">
                ...
                <?php print _hbs_dashboard_messages('region_subregion_employment'); ?>
            </div>
            <div class="col-md-12 chart chart-100">
