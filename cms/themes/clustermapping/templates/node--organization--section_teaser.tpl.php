...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php print render($title_suffix); ?>
    ...
    <div class="content"<?php print $content_attributes; ?>>
      <div class="container">
        <div class="row">
          <div class="col-md-<?php print $columns; ?>">
            <?php
          ...
          <?php if ($columns == 8): ?>
            <div class="col-md-4 org-right-rail">
              ...
              <?php if ($content['field_website'] && count($content['field_website']) > 1): ?>
                <div class="org-url">
                  <?php print render($content['field_website']); ?>
                </div>
              <?php endif; ?>

              <?php if ($content['field_organization_type'] && count($content['field_organization_type']) > 1): ?>
                <div class="org-url">
              ...
              <?php else: ?>
                <p class="no-data">No address available.</p>
              <?php endif; ?>
              </div>
