...
function create_importer(clusterData, clusters) {
    ...
    function calc_prosperity(a) {
        if (a.gross_domestic_product_private_industries_tf && a.total_population_tf) {
            a.gdp_per_capita_tf = a.gross_domestic_product_private_industries_tf / a.total_population_tf;
        }
    }
    ...
    function calc_laborforce_productivity(a) {
        if (a.labor_force_nsa_tf && a.gross_domestic_product_private_industries_tf) {
            a.labor_force_productivity_tf = a.gross_domestic_product_private_industries_tf / a.labor_force_nsa_tf;
        }
    }
    ...
    function calc_exports(a) {
        if (a.total_exports_over_time_tf && a.gross_domestic_product_private_industries_tf) {
            a.exports_tf = a.total_exports_over_time_tf / a.gross_domestic_product_private_industries_tf;
        }
    }
    ...
    function calc_taxes(a) {
        if (a.gross_domestic_product_private_industries_tf && a.state_and_local_revenue_total_tax_tf) {
            a.taxes_per_gdp_tf = a.state_and_local_revenue_total_tax_tf / a.gross_domestic_product_private_industries_tf;
        }
    }

    function calc_corp_taxes(a) {
        if (a.gross_domestic_product_private_industries_tf && a.state_and_local_revenue_corporate_net_income_tax_tf) {
            a.corp_taxes_per_gdp_tf = a.state_and_local_revenue_corporate_net_income_tax_tf / a.gross_domestic_product_private_industries_tf;
        }
    }
    ...
    function calc_venture_capital(row) {
        if (row.venture_capital_over_time_tf && row.gross_domestic_product_private_industries_tf) {
            row.venture_capital_per_gdp_tf = row.venture_capital_over_time_tf / (row.gross_domestic_product_private_industries_tf / 10000);
        }
    }
    ...
    function calc_agricultural_output(row) {
        if (+row.census_of_ag_total_sales_tf && +row.gross_domestic_product_private_industries_tf) {
            row.agricultural_output_gdp_tf = +row.census_of_ag_total_sales_tf * 1000 / +row.gross_domestic_product_private_industries_tf;
        }
    }
