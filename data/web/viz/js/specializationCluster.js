...
(function() {
        ...
        elements:[
          {
            ...
            label: function() { return totalData.region + " Overall Share of US " + totalData.type + " Employment: " + percentFormat(totalData.value) },
            attrs:{
              y1: 'y',
              y2: 'y',
          ...
          },
          {
            ...
            label: function() { return "Overall Change in the " + totalData.region + " Share of US " + totalData.type + " Employment: " + percentPlustFormat(totalData.change) },
            attrs:{
              x1: 'x',
              x2: 'x',
              style: 'stroke: #333; stroke-width: 2px',
        ...
        elements:[
          {
            ...
            append: [
              ...
              },
              {
                ...
                text: function(d){if (d) {return 'Specialization by ' + d.type + ', ' + d.start + ' to ' + d.end;}}
              },
              {
                type: 'p',
                ...
                append: [
                  {
                    ...
                    attrs: {
                      href: function(d) {
                        return '/region-cluster/' + ( totalData.clusterParentKey || totalData.clusterKey ) + '/' + totalData.type + '/' + d.key;
                      },
                      target: '_parent'
                    },
  ...
  function getDatasources() {
    return base + '/report/cluster/specialization' 
      + '/' + options.cluster
      + '/' + options.subcluster
      + '/' + options.start
      + '/' + options.end
