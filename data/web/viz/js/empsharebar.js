    ...
    plot = d3Plot()
      ...
      .layer('avgGuideLayer',{
        ...
        elements:[
          {
            type: 'line',
            label: function() { return totalData.region + ' average ' + totalData.type + ' wage: ' + numFormat(totalData.value);},
            axis: 'x',
            value : function() {
            ...
            attrs:{
              ...
              style: 'stroke: #169238; stroke-width: 4px; stroke-dasharray: 5,5'
            }
          }
        ]
      })
        ...
        elements:[
          {
            ...
            append: [
              ...
              },
              {
                ...
                text: function(d){if (d) {return 'Wages by ' + d.type + ' Cluster, ' + d.year;}}
              }]
          }
        ]})
      .layer('clusterDetail', {
